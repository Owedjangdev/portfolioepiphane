...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-surface/95 backdrop-blur-sm p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      <SheetPrimitive.Close className="absolute text-accent right-4 top-4  opacity-70 ring-offset-background transition-opacity">
